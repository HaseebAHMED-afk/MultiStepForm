...
function getSteps() {
  return ['Add an address', 'Payment', 'Review'];
}

function getStepContent(stepIndex , setStep , setFormValues , formValues) {
  switch (stepIndex) {
    case 0:
      return <AddressForm  submit={setStep} prevValues={formValues} setFormValues={setFormValues} />;
    case 1:
      return <PaymentForm submit={setStep} prevValues={formValues} setFormValues={setFormValues} />;
    case 2:
